...
export const resourceGroups: ResourceGroup[] = [
  {
    ...
    blurb: "مصادر حول تحليلات التعلم وقياس أثر التعلّم في البيئات الإلكترونية.",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { topic: "الملكية الفكرية", type: "فيديو يوتيوب", youtube: "h2f_q4VvTkE" },
      ...
      { topic: "الملكية الفكرية", type: "كتاب", pdf: "https://drive.google.com/file/d/1IMtL6Hmn_haOfK3Bz0xrCKc8oCc00GMd/view" },
